...
@Component({
  selector: 'app-add-update-stableford',
  templateUrl: './add-update-stableford.component.html',
  styleUrls: ['./add-update-stableford.component.css']
})
export class AddUpdateStablefordComponent implements OnInit {

 submitted = false;

  constructor(
    public dialogRef: MatDialogRef<AddUpdateStablefordComponent>,
